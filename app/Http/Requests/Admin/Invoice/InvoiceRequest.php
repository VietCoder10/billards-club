...
class InvoiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'table_total' => 'required|numeric|min:0|max:999999',
            'service_total' => 'required|numeric|min:0|max:999999',
            'final_total' => 'required|numeric|min:0|max:999999',
    ...
    public function messages(): array
    {
        return [
            ...
            'table_total.max' => 'Tiền bàn không được vượt quá 999999',
            ...
            'service_total.max' => 'Tiền dịch vụ không được vượt quá 999999',
            ...
            'discount.max' => 'Giảm giá không được vượt quá 999999',
