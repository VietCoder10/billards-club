    ...
    public function rules(): array
    {
        ...
        if ($id) {
            $rules = array_merge($rules, [
                ...
                'status' => 'required|integer|min:0|max:999999',
                'price_per_hour' => 'required|numeric|min:1|max:999999',
                'total_minutes' => 'nullable|integer|min:0|max:999999',
                'table_total' => 'nullable|numeric|min:0|max:999999',
                'service_total' => 'nullable|numeric|min:0|max:999999',
                'final_total' => 'nullable|numeric|min:0|max:999999',
