  ...
  en: {
    fields: {
      password: {
        ...
        password_str: 'Mật khẩu phải bao gồm chữ hoa và chữ thường.',
        password_number: 'Mật khẩu phải bao gồm ít nhất một số.'
      },
            ...
            <div class="flex flex-col items-center justify-center">
              <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                  ...
                  <div class="mb-4">
                    <label for="password_confirmation" class="block text-surface-900 dark:text-surface-0 mb-1">Xác nhận mật khẩu</label>
                  ...
                  <div class="flex items-center justify-between mt-2 gap-8 forgot-password">
                    <Link :href="route('admin.login.index')">Quay lại đăng nhập</Link>
                  </div>
                  <Button label="Đặt lại mật khẩu" type="submit" icon="pi pi-sign-in" class="w-full mx-auto mt-5"></Button>
                </div>
              </div>
            </div>
          </div>
